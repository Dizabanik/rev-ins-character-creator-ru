...
export const AVAILABLE_RACES: Race[] = [
  ...
  },
  {
    ...
    attributeModifiers: { dexterity: -5, strength: 2 }, 
    skillModifiers: { skill_acrobatics: -3},
  ...
  },
  {
    ...
    description: "Обитают в местах с богатой литературной аурой, таких как Город Чернильщиков. Имеют врожденные Информационные марки Дао и лучшие в Информационном пути и ценят знания. Их чернильная природа делает их уязвимыми к большому количеству воды.",
    attributeModifiers: {}, 
    specialAbilities: ["Врожденные Информационные марки Дао", "Способность к левитации (парению)", "Лучшие в Информационном пути"],
...
export const AVAILABLE_FEATS: Feat[] = [
    ...
    { 
      ...
      name: "Хилый (Изъян)", 
      description: "-1 к Телосложению. У вас помеха на проверки Телосложения. Можно выбрать для получения ОМ.", 
      requirements: [], 
